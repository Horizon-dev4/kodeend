            ...
            <div className="each_service mt-4">
              ...
              <div className="each_service_content">
                ...
                <ul className="pl-4">
                    ...
                    <li>
                        Company (referred to as either {`"the Company", "We", "Us" or "Our"`} in this Agreement) refers to KodeEnd IT Solutions AB, Räfsgatan 36, 216 33 Limhamn, Sweden.
                    </li>
                    <li>
                    ...
                    <li>
                        Website refers to kodeend, accessible from <a href="#">www.kodeend.com</a>.
                    </li>
                    <li>
